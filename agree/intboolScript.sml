...
Definition exprVal_def :
  ...
  exprVal E (FbyExpr e1 e2) t  = (if t = 0 then exprVal E e1 0 else exprVal E e2 t) /\
  exprVal E (CondExpr b e1 e2) t = (if bexprVal E b t
                                    then exprVal E e1 t else exprVal E e2 t)
  /\
